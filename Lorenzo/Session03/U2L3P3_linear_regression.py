...
#SF# Great work, just add more comments to follow more easily your workflow
...
#SF# Can also use the short-hand .T for transpose() 

#SF# Delete if you're not using this for clarity. You can always take it back using git!
